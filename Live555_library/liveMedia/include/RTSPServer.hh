...
// skkang, move from RTSPServer.cpp
...
public:
	static RTSPServer* createNew(UsageEnvironment& env, Port ourPort = 554, ipv4AddressBits ourIP = INADDR_ANY,
...
public: // should be protected, but some old compilers complain otherwise
  ...
  protected:
	...
	virtual void handleCmd_MaxClient();//skkang
...
private:
  ...
  //skkang
protected:
	  /*static*/ StreamingMode mDefaultStreamingMode;
public:
	void setStreamingMode(StreamingMode mode) { mDefaultStreamingMode = mode; }
	StreamingMode getStreamingMode() { return mDefaultStreamingMode; }
};
